...
/* package development-log-0.1.0.0 */
#ifndef VERSION_development_log
#define VERSION_development_log "0.1.0.0"
#endif /* VERSION_development_log */
#ifndef MIN_VERSION_development_log
#define MIN_VERSION_development_log(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_development_log */
...
#define CURRENT_COMPONENT_ID "development-log-0.1.0.0-GWKJCTAlMkJ9MK2oBRmtls-development-log"
